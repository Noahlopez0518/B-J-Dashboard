...
'
    ActiveWorkbook.SlicerCaches("Slicer_Payment_Method").ClearManualFilter
    ActiveWorkbook.SlicerCaches("Slicer_Buyer_Location").ClearManualFilter
    ActiveWorkbook.SlicerCaches("Slicer_Age_Group").ClearManualFilter
    ActiveWorkbook.SlicerCaches("Slicer_Months__Transaction_Date"). _
        ClearManualFilter
End Sub
